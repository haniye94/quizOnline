...
public class SettingActivity extends AppCompatActivity {
    ...
    private void moreAppClicked() {
        try{
            ...
            intent.setData(Uri.parse("bazaar://collection?slug=by_author&aid=" + R.string.more_apps_bazzar));
            intent.setPackage("com.farsitel.bazaar");
            startActivity(intent);
        }catch(Exception e){
            Toast.makeText(SettingActivity.this, "برنامه بازار نصب نمی باشد!" ,Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void shareClicked(String subject, String text) {
        ...
        intent.putExtra(android.content.Intent.EXTRA_TEXT, "https://cafebazaar.ir/app/" + getPackageName());
    ...
    public void fontSizeDialog() {
        ...
        dialog.setTitle("تغییر اندازه قلم");
