...
public class Constant {
    ...
    public static String QUIZ_URL = "http://Soalino.com/panel_admin/api-v2.php"; // admin page url

    public static String DEVICE_REGISTRATION_API = "http://Soalino.com/panel_admin/api-v2.php";
